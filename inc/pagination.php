...
if ( ! function_exists( 'dlm_theme_pagination' ) ) {
    /**
     ...
     */
    function dlm_theme_pagination( $query = null, $args = array(), $class = 'pagination' ) {
        global $wp_query;
        ...
        $args = wp_parse_args(
            ...
            array(
                ...
                'mid_size'           => 2,
                // 'prev_next'          => true,
                // 'prev_text'          => __( '&laquo;', 'dlm_theme' ),
                // 'next_text'          => __( '&raquo;', 'dlm_theme' ),
                'type'               => 'array',
                'current'            => max( 1, get_query_var( 'paged' ) ),
                'screen_reader_text' => __( 'Posts navigation', 'dlm_theme' ),
            )
        );
